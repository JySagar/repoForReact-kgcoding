...
function App() {
  ...
  return (
    // Here we added react freagment bcoz App can render only one element so since here are two i.e. h1 an
    // ul so used to wrap them in a div but since it will add another node to the DOM which is here div so we add react fragment which doesnot affect the DOM. We can also do it by only using the angular braces.
    <React.Fragment>
